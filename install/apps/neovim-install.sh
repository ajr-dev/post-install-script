...
sudo apt-get install -y build-essential cmake software-properties-common python-software-properties
...
sudo apt-get install -y python-dev python-pip python3-dev python3-pip python3-setuptools
