...
dconf write /org/cinnamon/desktop/interface/text-scaling-factor 1.3
...
dconf write /org/cinnamon/desktop/keybindings/custom-keybindings/custom2/name "'Terminal Fullscreen'"
dconf write /org/cinnamon/desktop/keybindings/custom-keybindings/custom1/command "'gnome-terminal --full-screen'"
